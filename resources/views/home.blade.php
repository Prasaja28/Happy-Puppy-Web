                    ...
                    <div class="card-body pb-0">
                        <div class="card-title">
                            <h4 class="font-weight-none pt-1 pt-md-3">
                                {{ $news_terbaru[0]->{'news_title_' . app()->getLocale()} }}
                            </h4>
                            <div class="date d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('detailNews', ['id' => $news_terbaru[0]->id]) }}" class="clickArea"><img src="{{ asset('img/book.png') }}"></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body pb-0">
                        <div class="card-title">
                            ...
                            <div class="date d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('detailNews', ['id' => $news_terbaru[1]->id]) }}" class="clickArea"><img src="{{ asset('img/book.png') }}"></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div name="item" class="col-11 col-md-8 px-0 mb-5 item">
                ...
                <div name="description" class="pr-1 pr-md-3">
                    ...
                    <div class="date d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('detailNews', ['id' => $newst->id]) }}" class="pr-2 pr-md-0 itemClick"><img src="{{ asset('img/book.png') }}"></a>
                    </div>
                </div>
