<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="edit{{ $songlists->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('/songlist-admin/update/' . $songlists->id) }}" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                            class="form-control form-control-border @error('title_song') is-invalid @enderror"
                            id="title_song" placeholder="Title Song" name="title_song"
                            value="{{ $songlists->title_song }}" required>
                        @error('title_song')
                    ...
                    <div class="item form-group" style="margin-right:-40px;">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                            style="text-align:left; margin-right: -100px;">Thumbnail Song</label>
                        <div class="col-md-9 col-sm-6 col-xs-12" style="margin-left:60px;">
                            ...
                            <img src="/uploads/{{ $songlists->thumbnail }}" alt="Tidak Ada gambar"
                            ...
                            <input type="text" hidden class="form-control @error('thumbnail2') is-invalid @enderror"
                                id="thumbnail2" name="thumbnail2" value="{{ $songlists->thumbnail }}">
                        </div>
                    </div>
                    <div class="form-group">
