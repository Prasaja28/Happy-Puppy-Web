<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="edit{{ $topartists->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('/topartist-admin/update/' . $topartists->id) }}" method="post"
                    ...
                    <div class="item form-group" style="margin-right:-40px;">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                            style="text-align:left; margin-right: -100px;">Thumbnail Top Artist (1x1)</label>
                        <div class="col-md-9 col-sm-6 col-xs-12" style="margin-left:60px;">
                            ...
                            <img src="/uploads/{{ $topartists->thumbnail }}" alt="Tidak Ada gambar"
                                style="width:100px; height:100px; margin-top:10px;">
                            <input type="text" hidden class="form-control @error('thumbnail2') is-invalid @enderror"
                                id="thumbnail2" name="thumbnail2" value="{{ $topartists->thumbnail }}">
                        </div>
                    </div>
                    <div class="form-group">
