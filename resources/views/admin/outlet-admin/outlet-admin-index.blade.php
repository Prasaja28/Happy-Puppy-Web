...
@for($i = 0; $i < count(Session::get('roles')); $i++) @if(session('roles')[$i]['roles_id']==1 || session('roles')[$i]['roles_id']==6) @extends('admin/layout-komponen/master') @section('title', 'Outlet/Waralaba' ) @section('css') <!-- css internal place -->
    <!-- DataTables -->
                            ...
                            <table id="example2" class="table table-bordered table-striped ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="/uploads/{{ $outlet->thumbnail }}" width="100" height="100" alt="">
                                        </td>
                                        <td>{{ $outlet->name }}</td>
