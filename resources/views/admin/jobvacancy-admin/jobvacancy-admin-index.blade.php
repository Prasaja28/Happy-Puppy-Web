@if (Session::get('status_user') == '1' || Session::get('status_user') == '12')
                    ...
                    <div class="col-md-12 my-2">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Data Jobvacancy</h3>
                            </div>
                            <!-- /.card-header -->
                                ...
                                <table id="example2" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        @forelse($jobs as $users)
                                            ...
                                            <!-- Model Delete -->
                                            @include('admin.jobvacancy-admin.jobvacancy-admin-delete')
                                            <!-- Model Update -->
                                            @include('admin.jobvacancy-admin.jobvacancy-admin-update')
                                        @empty
                                            <div class="alert alert-danger">
                                                Data Jobvacancy belum Tersedia.
                                            </div>
                                        @endforelse
                                    </tbody>
                                    <tfoot>
