            ...
            <div class="modal-body">
                ...
                @csrf
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-border @error('name') is-invalid @enderror" id="artis" placeholder="Name User" name="name" value="{{ old('name') }}" required>
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select form-control-border  @error('role') is-invalid @enderror" id="role" name="role" value="{{ old('role') }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control form-control-border @error('email') is-invalid @enderror" id="artis" placeholder="Email User" name="email" value="{{ old('email') }}" required>
                        @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
